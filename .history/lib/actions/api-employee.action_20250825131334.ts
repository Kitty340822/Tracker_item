...
//     if (success) {
//       console.log("Data from getEmployeeList:", data);
//       return {
//         success: true,
//         data,
...
//       };
//     }
//     console.error("API get user list failed:", error);
//     return {
//       success: false,
//       data: [],
//       error,
...
// }> {
//   try {
//     const response = await fetch(`${env.DATABASE_URL}/api/v2/user/${id}`, {
//       method: "GET",
//       headers: {
//         "Content-Type": "application/json",
//         apikey: env.API_KEY,
...
//   try {
//     const response = await fetch(`${env.DATABASE_URL}/api/v2/user`, {
//       method: "POST",
//       headers: {
//         "Content-Type": "application/json",
//         apikey: env.API_KEY,
...
// }> {
//   try {
//     const response = await fetch(`${env.DATABASE_URL}/api/v2/user/permission`, {
//       method: "GET",
//       headers: {
//         "Content-Type": "application/json",
//         apikey: env.API_KEY,
