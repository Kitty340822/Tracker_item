...
function createEmployee(values: { name: string; password: string; email: string; phone?: string | undefined; role_permission?: string | undefined; }): { success: any; error: any; } | PromiseLike<{ success: any; error: any; }> {
